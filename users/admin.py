...
class StudentAdmin(CustomUserAdmin, ImportExportModelAdmin):
	...
	fieldsets = CustomUserAdmin.fieldsets + (
		(_('Student Information'), {'fields': ('telegram', 'about', 'portfolio_link', 'in_lite', 'bank_account_id', 'status', 'direction', 'student_profile', 'achievement')}),
	)
	list_display = CustomUserAdmin.list_display + ('telegram', 'about', 'portfolio_link', 'in_lite', 'bank_account_id', 'status', 'direction_list', 'student_profile', 'achievement_list')
