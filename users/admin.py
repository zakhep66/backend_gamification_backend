...
from .admin_resources import EmployeeResource, StudentResource, DirectionResource, BankAccountResource, \
	CustomBaseUserResource
from .forms import CustomAdminPasswordChangeForm
from .models import Student, Employee, Direction, BankAccount, StudentProfile, CustomUser
...
class CustomBaseUserAdmin(ImportExportModelAdmin):
	resource_class = CustomBaseUserResource
